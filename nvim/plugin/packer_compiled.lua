...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/home/kidp2h/.local/share/nvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
  ...
  ale = {
    loaded = true,
    path = "/home/kidp2h/.local/share/nvim/site/pack/packer/start/ale",
  ...
  ["bufferline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/kidp2h/.local/share/nvim/site/pack/packer/opt/bufferline.nvim",
  ...
  extensions = {
    loaded = true,
    path = "/home/kidp2h/.local/share/nvim/site/pack/packer/start/extensions",
  ...
  ["nvim-lsp-installer"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/kidp2h/.local/share/nvim/site/pack/packer/opt/nvim-lsp-installer",
  ...
  ["packer.nvim"] = {
    loaded = true,
    path = "/home/kidp2h/.local/share/nvim/site/pack/packer/start/packer.nvim",
  ...
  ["which-key.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/kidp2h/.local/share/nvim/site/pack/packer/opt/which-key.nvim",
